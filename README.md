...
* Regexp testing `!` http://regexpal.com/
* Regexp docs https://developer.mozilla.org/en/JavaScript/Guide/Regular_Expressions
* Comparison of documentation generators http://en.wikipedia.org/wiki/Comparison_of_documentation_generators
* http://arandomurl.com/2011/04/02/jquery-couch-js-documentation.html `docs`
* https://github.com/visionmedia/dox `docs` `md`
* docco (I have a clone) http://jashkenas.github.com/docco/ `docs`
...
* http://johnpolacek.github.com/scrollorama/ `scroll`
